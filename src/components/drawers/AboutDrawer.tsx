        ...
        <div className="drawer-body">
          <section className="about-card" data-testid="card-about">
            ...
            <div className="about-meta">
              ...
              <span style={{ fontWeight: 600, color: 'var(--accent)' }}>v4.8.5</span>
            </div>
            <div className="support-actions">
              ...
              <a className="btn" href="https://south-lebanon-map.vercel.app/gps-speed-test.html" target="_blank" rel="noopener noreferrer" data-testid="link-about-speed-test">
                🧪 בדיקת מהירות
              </a>
