...
export const towns: Town[] = [
  ...
  { id: 'naqoura', name_he: 'נאקורה', name_en: 'Naqoura', lat: 33.1183, lon: 35.1400, pop_band: 'md', pop_estimate: 5000, side: 'LB', note: 'מטה יוניפי״ל' },
  { id: 'alma',    name_he: 'עלמא א־שעב', name_en: 'Alma al-Shaab', lat: 33.1039, lon: 35.1828, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'dhayra',  name_he: 'דהירה', name_en: 'Dhayra', lat: 33.0985, lon: 35.1620, pop_band: 'sm', pop_estimate: 1200, side: 'LB' },
  { id: 'mansouri', name_he: 'אל־מנסורי', name_en: 'Al Mansouri', lat: 33.1630, lon: 35.2150, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'majd-zoun', name_he: 'מג׳דל זון', name_en: 'Majdal Zoun', lat: 33.1460, lon: 35.2070, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'zibqin', name_he: 'זבקין', name_en: 'Zibqin', lat: 33.1780, lon: 35.2550, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'siddiqin', name_he: 'סידיקין', name_en: 'Siddiqin', lat: 33.1900, lon: 35.3103, pop_band: 'sm', pop_estimate: 3000, side: 'LB' },
  { id: 'ramadiyeh', name_he: 'רמדייה', name_en: 'Ramadiyeh', lat: 33.1980, lon: 35.2850, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'hallousiyeh', name_he: 'חלוסייה', name_en: 'Hallousiyeh', lat: 33.2360, lon: 35.3100, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'maaroub', name_he: 'מערוב', name_en: 'Maaroub', lat: 33.2480, lon: 35.3200, pop_band: 'sm', pop_estimate: 3000, side: 'LB' },
  { id: 'selaa', name_he: 'סלעא', name_en: 'Selaa', lat: 33.1930, lon: 35.3750, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'batoulay', name_he: 'באטוליה', name_en: 'Batoulay', lat: 33.2100, lon: 35.2550, pop_band: 'sm', pop_estimate: 1600, side: 'LB' },
  { id: 'aitaa',   name_he: 'עיתא א־שעב', name_en: 'Aita al-Shaab', lat: 33.0972, lon: 35.3344, pop_band: 'md', pop_estimate: 8000, side: 'LB' },
  { id: 'rmeish',  name_he: 'רמייש', name_en: 'Rmeish', lat: 33.0792, lon: 35.3689, pop_band: 'md', pop_estimate: 6500, side: 'LB' },
  { id: 'yater', name_he: 'יאטר', name_en: 'Yater', lat: 33.1539, lon: 35.3286, pop_band: 'md', pop_estimate: 4500, side: 'LB' },
  { id: 'haris', name_he: 'חריס', name_en: 'Haris', lat: 33.1744, lon: 35.3767, pop_band: 'md', pop_estimate: 4000, side: 'LB' },
  { id: 'hadatha', name_he: 'חדאתא', name_en: 'Hadatha', lat: 33.1667, lon: 35.3833, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'beit-yahoun', name_he: 'בית יאחון', name_en: 'Beit Yahoun', lat: 33.1592, lon: 35.4217, pop_band: 'sm', pop_estimate: 2200, side: 'LB', note: 'סמוך לרכס הסילבסטר' },
  { id: 'rachaf', name_he: 'רשאף', name_en: 'Rachaf', lat: 33.1850, lon: 35.4430, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'hanine', name_he: 'חאנין', name_en: 'Hanine', lat: 33.1856, lon: 35.2236, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'kafra', name_he: 'כפרא', name_en: 'Kafra', lat: 33.1758, lon: 35.3514, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'yaroun',  name_he: 'יארון', name_en: 'Yaroun', lat: 33.0806, lon: 35.4225, pop_band: 'sm', pop_estimate: 2000, side: 'LB' },
  { id: 'maroun',  name_he: 'מארון א־ראס', name_en: 'Maroun al-Ras', lat: 33.1075, lon: 35.4447, pop_band: 'sm', pop_estimate: 1200, side: 'LB' },
  ...
  { id: 'tibnin',  name_he: 'תיבנין', name_en: 'Tibnin', lat: 33.1933, lon: 35.4108, pop_band: 'md', pop_estimate: 7500, side: 'LB' },
  { id: 'sultaniyeh', name_he: 'סולטאנייה', name_en: 'Sultaniyeh', lat: 33.2050, lon: 35.4053, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'tulin', name_he: 'תולין', name_en: 'Tulin', lat: 33.2220, lon: 35.4480, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'majdal-selm', name_he: 'מג׳דל סלם', name_en: 'Majdal Selm', lat: 33.2310, lon: 35.4960, pop_band: 'sm', pop_estimate: 3500, side: 'LB' },
  { id: 'souaneh', name_he: 'סואנה', name_en: 'Souaneh', lat: 33.2470, lon: 35.4550, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'khirbet-selm', name_he: 'ח׳רבת סלם', name_en: 'Khirbet Selm', lat: 33.2180, lon: 35.4700, pop_band: 'sm', pop_estimate: 3000, side: 'LB' },
  { id: 'deir-ntar', name_he: 'דיר נטר', name_en: 'Deir Ntar', lat: 33.2186, lon: 35.3758, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'froun', name_he: 'פרון', name_en: 'Froun', lat: 33.2969, lon: 35.4286, pop_band: 'sm', pop_estimate: 2000, side: 'LB' },
  { id: 'ghandouriyeh', name_he: 'גנדוריה', name_en: 'Ghandouriyeh', lat: 33.2700, lon: 35.4840, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'qantara', name_he: 'קנטרה', name_en: 'Qantara', lat: 33.2460, lon: 35.5350, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'deir-siryan', name_he: 'דיר סיריאן', name_en: 'Deir Siryan', lat: 33.2520, lon: 35.5310, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'blida',   name_he: 'בלידה', name_en: 'Blida', lat: 33.1400, lon: 35.5153, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'mais',    name_he: 'מייס א־ג׳בל', name_en: 'Mais al-Jabal', lat: 33.1694, lon: 35.5256, pop_band: 'md', pop_estimate: 3500, side: 'LB' },
  { id: 'houla',   name_he: 'חולא', name_en: 'Houla', lat: 33.2100, lon: 35.5169, pop_band: 'md', pop_estimate: 5000, side: 'LB' },
  { id: 'markaba', name_he: 'מרכבא', name_en: 'Markaba', lat: 33.2333, lon: 35.5167, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'adaiss',  name_he: 'אל־עדייסה', name_en: 'Adaisseh', lat: 33.1330, lon: 35.5680, pop_band: 'sm', pop_estimate: 1500, side: 'LB' },
  { id: 'kfark',   name_he: 'כפר כלא', name_en: 'Kfar Kila', lat: 33.2789, lon: 35.5556, pop_band: 'md', pop_estimate: 6000, side: 'LB' },
  { id: 'khiam',   name_he: 'אל־ח׳יאם', name_en: 'Khiam', lat: 33.3272, lon: 35.6111, pop_band: 'md', pop_estimate: 22000, side: 'LB' },
  { id: 'marjay',  name_he: 'מרג׳עיון', name_en: 'Marjayoun', lat: 33.3619, lon: 35.5897, pop_band: 'md', pop_estimate: 9000, side: 'LB' },
  { id: 'ghajar-lb', name_he: "ע'ג'ר", name_en: 'Ghajar (LB)', lat: 33.2728, lon: 35.6231, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'burj-el-muluk', name_he: 'בורג׳ אל־מלוכ', name_en: 'Burj el-Muluk', lat: 33.3280, lon: 35.5980, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'kawkaba', name_he: 'כוכבא', name_en: 'Kawkaba', lat: 33.3230, lon: 35.6470, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'kfar-hamam', name_he: 'כפר חמאם', name_en: 'Kfar Hamam', lat: 33.3100, lon: 35.6610, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'hebbariyeh', name_he: 'הבארייה', name_en: 'Hebbariyeh', lat: 33.3230, lon: 35.7000, pop_band: 'sm', pop_estimate: 2000, side: 'LB' },
  { id: 'ain-arab', name_he: 'עין ערב', name_en: 'Ain Arab', lat: 33.2920, lon: 35.6850, pop_band: 'sm', pop_estimate: 1500, side: 'LB' },
  { id: 'mari', name_he: 'מארי', name_en: 'Mari', lat: 33.2920, lon: 35.6200, pop_band: 'sm', pop_estimate: 1200, side: 'LB' },
  { id: 'tyre',    name_he: 'צור', name_en: 'Tyre / Sour', lat: 33.2700, lon: 35.2030, pop_band: 'xl', pop_estimate: 120000, side: 'LB' },
  { id: 'burj-el-shemali', name_he: 'בורג׳ א־שמאלי', name_en: 'Burj el-Shemali', lat: 33.2860, lon: 35.2370, pop_band: 'md', pop_estimate: 10000, side: 'LB' },
  { id: 'rashidiyeh', name_he: 'ראשידייה', name_en: 'Rashidiyeh', lat: 33.2360, lon: 35.2220, pop_band: 'md', pop_estimate: 7000, side: 'LB' },
  { id: 'ain-baal', name_he: 'עין בעל', name_en: 'Ain Baal', lat: 33.2920, lon: 35.2900, pop_band: 'md', pop_estimate: 5000, side: 'LB' },
  { id: 'hanaouay', name_he: 'חנאווייה', name_en: 'Hanaouay', lat: 33.2520, lon: 35.3300, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'derdkaya', name_he: 'דרדקאיה', name_en: 'Derdghaya', lat: 33.2920, lon: 35.3460, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  ...
  { id: 'mayfadoun', name_he: 'מייפדון', name_en: 'Mayfadoun', lat: 33.3600, lon: 35.4750, pop_band: 'sm', pop_estimate: 3500, side: 'LB' },
  { id: 'zibdine', name_he: 'זבדין', name_en: 'Zibdine', lat: 33.3950, lon: 35.5030, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'jibchit', name_he: 'ג׳יבשית', name_en: 'Jibchit', lat: 33.3600, lon: 35.4330, pop_band: 'md', pop_estimate: 5000, side: 'LB' },
  { id: 'shoukine', name_he: 'שוקין', name_en: 'Shoukine', lat: 33.3970, lon: 35.5150, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'kfar-jaouz', name_he: 'כפר ג׳וז', name_en: 'Kfar Jaouz', lat: 33.3820, lon: 35.5120, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'kana',    name_he: 'קאנא', name_en: 'Qana', lat: 33.2090, lon: 35.3030, pop_band: 'md', pop_estimate: 12000, side: 'LB' },
  { id: 'bafliyeh', name_he: 'בפלייה', name_en: 'Bafliyeh', lat: 33.2410, lon: 35.3500, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  { id: 'jwaya-west', name_he: 'ג׳וויא מערב', name_en: 'Jwaya area', lat: 33.2500, lon: 35.3870, pop_band: 'sm', pop_estimate: 2200, side: 'LB', note: 'נקודת ייחוס באזור ג׳וויא' },
  { id: 'mahrouneh', name_he: 'מחרונה', name_en: 'Mahrouneh', lat: 33.2750, lon: 35.3880, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'barish', name_he: 'באריש', name_en: 'Barish', lat: 33.2731, lon: 35.3539, pop_band: 'sm', pop_estimate: 2200, side: 'LB' },
  ...
  { id: 'braachit', name_he: 'ברעשית', name_en: 'Braachit', lat: 33.1761, lon: 35.4433, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  ...
  { id: 'deir-mimas', name_he: 'דיר מימאס', name_en: 'Deir Mimas', lat: 33.3019, lon: 35.5453, pop_band: 'sm', pop_estimate: 1800, side: 'LB' },
  { id: 'qlaiaa',  name_he: 'קליעה', name_en: 'Qlayaa', lat: 33.3380, lon: 35.5750, pop_band: 'sm', pop_estimate: 2500, side: 'LB' },
  { id: 'ebel-saqi', name_he: 'אבל א־סאקי', name_en: 'Ebel es-Saqi', lat: 33.3573, lon: 35.6275, pop_band: 'sm', pop_estimate: 2000, side: 'LB' },
  ...
  { id: 'maarakeh', name_he: 'מערכה', name_en: 'Maarakeh', lat: 33.2728, lon: 35.3097, pop_band: 'md', pop_estimate: 7000, side: 'LB' },
